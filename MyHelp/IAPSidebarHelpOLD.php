...
<img src='MyHelp/LHCQuestionMark.png' class='tooltip' title='Choosing one of these options overrides your choice on the "About Me" page for this page only. Typical usage is to turn on full help for difficult pages or while learning a page when the standard choice is no help or minimal help. Remember the level of help set here is only for this page. To set the help level for the entire application, see the "About Me" page. Changes here will take affect the next time the page is displayed.'>
...
function procHelpChoice() {
	...
	var hUserId = <?php echo $iapCurrentUser['ID']; ?>;
