...
?>
	...
	<tr><td style="width:16%;"><span class=iapFormLabel>Payment Method:</span></td>
		<td style="width:84%;">
			<input <?php echo $iapReadOnly; ?> tabindex='40' name="spayment" id="spaycash" value="spaycash" type="radio" onchange="sPayChg();">Cash
			&nbsp;&nbsp;
			<input <?php echo $iapReadOnly; ?> name="spayment" id="spaycredit" value="spaycredit" type="radio" onchange="sPayChg();">Debit/Credit Card 
	</td></tr>
