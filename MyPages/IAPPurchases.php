...
<picture>
    ...
    <img src="".$_REQUEST['IAPUrl']."/MyImages/GoGreen.png" alt="GO!" style="width:auto;"> // style="width:304px;height:228px;">
</picture>
*/
...
?>
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	<label class=iapFormLabel>Date of Purchase:</label>&nbsp;<input <?php echo $iapReadOnly; ?> placeholder="mm/dd/yyyy" maxlength="15" size="15" tabindex="1" name="pPurDate" id="pPurDate" value="<?php echo $d3; ?>">
	<br>

	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	<label class=iapFormLabel>Purchase Type: </label>
	   <input <?php echo $iapReadOnly; ?> tabindex="2" name="pPurType" value="I" type="radio"<?php if ($iapPurchase['pur_type'] == "I") echo " checked"; ?>> For Inventory
	   &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	   <input <?php echo $iapReadOnly; ?> tabindex="3" name="pPurType" value="S" type="radio"<?php if ($iapPurchase['pur_type'] == "S") echo " checked"; ?>> For Supplies
		&nbsp;&nbsp;&nbsp;<?php echo IAP_Do_Help(1, 208, 2);  //		Help Narative	<!-- level 1, page 208, section 2 --> ?>
	<br>

	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	<label class=iapFormLabel>Purchase From:</label>&nbsp;<input <?php echo $iapReadOnly; ?> maxlength="50" size="30" tabindex="3" name="pPurVendor" id="pPurVendor" value="<?php echo $iapPurchase['pur_vendor']; ?>">
	&nbsp;&nbsp; 

	<label class=iapFormLabel>Order Number:</label>&nbsp;
	<input <?php echo $iapReadOnly; ?> type='text' maxlength="20" size="20" tabindex="4" name="pPurOrder" id="pPurOrder" value="<?php echo $iapPurchase['pur_order']; ?>" onblur="pCheckPO()">
	<br>
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	...
	<br>
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	<label class=iapFormLabel>Mileage:</label>&nbsp;<input <?php echo $iapReadOnly; ?> maxlength="10" size="10" tabindex="8" name="pPurMiles" id="pPurMiles" align="right" step="0.1" value=<?php echo $iapPurchase['pur_miles']; ?>>
	&nbsp;&nbsp;
	<label class=iapFormLabel>Other Expenses:</label>&nbsp;<input <?php echo $iapReadOnly; ?> maxlength="10" size="10" tabindex="9" name="pPurExp" id="pPurExp" align="right" step="0.1" value=<?php echo $iapPurchase['pur_expenses']; ?>>
	<span style="font-size: 80%">Do not include shipping or tax</span>
	<br>
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	<label class=iapFormLabel>Explain Expenses:</label>&nbsp;
	<textarea name='pExpExp' id='pExpExp' cols='50' rows='4' wrap='soft' tabindex="10" <?php echo $iapReadOnly; ?>><?php echo $iapPurchase['pur_exp_explained']; ?></textarea>
	<br>
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	<label class=iapFormLabel id=pCommLbl>Comments:</label>
	<textarea name='pComment' id='pComment' cols='60' rows='4' wrap='soft' tabindex="11" style="text-indent: 15;" <?php echo $iapReadOnly; ?>><?php echo $iapPurchase['pur_comment']; ?></textarea>
...
?>
		...
		<div id="UsePriceDiv" style="text-align: left; display: none;">
			...
			<input type="checkbox" id="pUsePrc" tabindex="20" onclick="pSetUsePrice()">	
		</div>
		...
		<input tabindex='21' size='50' name='pItemCd' id='pItemCd' list='iapICD' onfocus='pItemFocus()' />
		&nbsp;&nbsp;&nbsp;<input type='button' class=iapButton name='pAddNewItem' id='pAddNewItem' value='Add A New Item' onclick='pNIClicked(); return false;' />
		<br>
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		<label for="pItemDesc" class=iapFormLabel id=pItemDescLbl>Description:</label>&nbsp;
		<input tabindex='23' maxlength='100' size='50' name='pItemDesc' id='pItemDesc' onfocus='pItemFocus()' />
		<br>
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		<label class=iapFormLabel id=pItemQtyLbl>Quantity:</label>&nbsp;<input <?php echo $iapReadOnly; ?> type='number' maxlength="10" size="10" tabindex="24" name="pItemQty" id="pItemQty" step="1">
		&nbsp;&nbsp;
		<label class=iapFormLabel id="pItemCostLbl">Unit Cost:</label>&nbsp;<input <?php echo $iapReadOnly; ?> type='number' maxlength="10" size="10" tabindex="25" name="pItemCost" id="pItemCost" step="0.01">
		<br>
		...
		<div id="iapNewItem" style="text-align: left; display: none;">
			...
			<br>
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			<label class=iapFormLabel id=pNewUnitsLbl>Saleable Units In Package:</label>&nbsp;<input <?php echo $iapReadOnly; ?> type='number' maxlength="10" size="10" tabindex="27" name="pNewUnits" id="pNewUnits" step="1">
			&nbsp;&nbsp;
			<label class=iapFormLabel id=pNewPriceLbl>Sale Price:</label>&nbsp;<input <?php echo $iapReadOnly; ?> type='number' maxlength="10" size="10" tabindex="28" name="pNewPrice" id="pNewPrice" step="0.01">
			<br>
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			<label class=iapFormLabel id=pNewCatLbl>Category:</label>&nbsp;<select <?php echo $iapReadOnly; ?> tabindex="29" name=pNewCat id=pNewCat size='1'><option value='---'>Select A Category</option><?php echo $iapCOpts; ?></select>
		</div>

		<div style="width:100%; vertical-align:middle; text-align:center;">
			<input class=iapButton type='button' tabindex='30' name='pRecItem' id='pRecItem' value='Record This Item' onclick='pRecordItem(); return false;'>
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			<input class=iapButton type='button' tabindex='31' name='pClearItem' id='pClearItem' value='Clear This Item&apos;s Data' onclick='pClrItemData(); return false;'>
...
<br>
<label class=iapFormLabel>Net Cost:</label>&nbsp;<input  readonly="readonly" maxlength="15" size="15" name="pPurNet" id="pPurNet" align="right" step="0.01" value=<?php echo $iapPurchase['pur_net']; ?>>
&nbsp;&nbsp;
<label class=iapFormLabel>Shipping Cost: </label>&nbsp;<input <?php echo $iapReadOnly; ?> type=number maxlength="12" size="12" tabindex="31" name="pShipping" id="pShipping" step="0.01" value=<?php echo $iapPurchase['pur_shipping']; ?>>
&nbsp;&nbsp; 
<label class=iapFormLabel>Sales Tax:</label>&nbsp;<input <?php echo $iapReadOnly; ?> type=number maxlength="12" size="12" tabindex="32" name="pSalesTax" id="pSalesTax" step="0.01" value=<?php echo $iapPurchase['pur_tax']; ?>>
...
<?php
if ($iapReadOnly != "readonly") {
	echo "<input class=iapButton tabindex='40' type='submit' name='pSubmit' id='pSubmit' value='Submit' onclick='return pSendForm();'>";
	echo "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;";
	echo "<input class=iapButton tabindex='41' type='button' name='pClear' id='pClear' value='Clear' onclick='pClearForm(); return false;'>";
...
<?php
require_once($_REQUEST['LHCPath']."IAP/MyJS/NonJSMin/JSPurc.js");
// require_once($_REQUEST['LHCPath']."IAP/MyJS/JSPurc.min.js");
