...
// -------------------------------------------------------------------------------------------------
// This function will provide a backup of all company data as it exists in our db.
// It should not be useable by the person on their computer or website
//
// back up w/o company 
// first serialize($IAPToSave) the data
// then encrypt it.
// put bu rec in front showing a name, date and time backed update
// save the back name, date, time, and encrption key
// ------------------------------------------------------------------------------------------------
